...
public class WordBreak {
	public static boolean wordBreak(String s, List<String> wordDict) {
		...
		return wordBreak(s, wordDict, 0, b);

	}

	public static boolean wordBreak(String s, List<String> wordDict, int start, Boolean b[]) {
		if (start == s.length())
			return true;
		if (b[start] != null) {
		...
		for (int i = start + 1; i <= s.length(); i++) {
			String sna = s.substring(start, i);
			if ((wordDict.contains(sna)) && wordBreak(s, wordDict, i, b)) {
	...
	static String a[] = { "kfomka", "hecagbngambii", "anobmnikj", "c", "nnkmfelneemfgcl", "ah", "bgomgohl", "lcbjbg",
			...
			"eklingemgdjncaa", "m", "hkh", "fblb", "fk", "nnfkfanaga", "eldjml", "iejn", "gbmjfdooeeko", "jafogijka",
			"ngnfggojmhclkjd", "bfagnfclg", "imkeobcdidiifbm", "ogeo", "gicjog", "cjnibenelm", "ogoloc", "edciifkaff",
			"kbeeg", "nebn", "jdd", "aeojhclmdn", "dilbhl", "dkk", "bgmck", "ohgkefkadonafg", "labem", "fheoglj",
			"gkcanacfjfhogjc", "eglkcddd", "lelelihakeh", "hhjijfiodfi", "enehbibnhfjd", "gkm", "ggj", "ag", "hhhjogk",
			"lllicdhihn", "goakjjnk", "lhbn", "fhheedadamlnedh", "bin", "cl", "ggjljjjf", "fdcdaobhlhgj", "nijlf", "i",
			"gaemagobjfc", "dg", "g", "jhlelodgeekj", "hcimohlni", "fdoiohikhacgb", "k", "doiaigclm", "bdfaoncbhfkdbjd",
			"f", "jaikbciac", "cjgadmfoodmba", "molokllh", "gfkngeebnggo", "lahd", "n", "ehfngoc", "lejfcee", "kofhmoh",
